...
print("Na segunda irá estudar",estudos["segunda"])
print("Na terca irá estudar",estudos["terca"])
print("Na quarta irá estudar",estudos["quarta"])
print("Na quinta irá estudar",estudos["quinta"])
print("Na sexta irá estudar",estudos["sexta"])
